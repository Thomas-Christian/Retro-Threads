...
export default function SignUpForm() {
	...
	<div className="w-full bg-primary rounded-lg shadow md:mt-0 sm:max-w-lg xl:p-0">
			...
			<form className="m-2 p-2 flex flex-col" onSubmit={handleSubmit}>
					...
					<label className="form-label-style" htmlFor="firstName">First Name</label>
					<input
						required
					...
					<label className="form-label-style" htmlFor="lastName">Last Name</label>
						<input
							required
							value={user.lastName}
						...
						<label className="form-label-style" htmlFor="password">Password</label>
						<input
							type="password"
							required
							value={user.password}
