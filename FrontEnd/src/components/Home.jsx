      ...
      <>
        ...
        bg-scroll bg-hero bg-center bg-repeat -z-20">
          ...
          <div id="top-half" className="w-full h-full flex flex-row flex-wrap justify-evenly mt-[10%] mb-[15%]">
            ...
            <div id="default-carousel" className="container flex w-[60%] overflow-hidden bg-primary border border-neutral-200 bg-opacity-80 rounded-lg items-center m-4">
            ...
            <div id="search" className="flex flex-col h-full m-4 p-2 border
            ...
            <HideOn height={100}> 
            <FontAwesomeIcon className="fixed bottom-8 animate-bounce invisible xl:visible text-primary" icon={faArrowDown} size="3x" />
            </HideOn>
          ...
          <div id="new-listings" className="bg-quintiary flex flex-col mx-3 mt-[5%] mb-[10%] p-2 rounded-md bg-opacity-80 w-min md:w-[85%] border-neutral-20 border">
